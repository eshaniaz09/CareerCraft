...
export const themes = {
  basic: {
    ...
    sectionContentStyle: 'mt-2 text-gray-800',
  ...
  casual: {
    ...
    sectionContentStyle: 'mt-3 text-gray-800',
  ...
  professional: {
    ...
    sectionContentStyle: 'mt-3 pl-3 border-l-2 border-blue-500/30 text-gray-800',
  ...
  creative: {
    ...
    sectionContentStyle: 'mt-4 p-4 rounded-lg text-gray-800 bg-pink-50/50',
  ...
  modern: {
    ...
    sectionContentStyle: 'mt-4 grid grid-cols-1 gap-4 text-gray-800',
    backgroundClass: 'bg-white',
  ...
  business: {
    ...
    sectionContentStyle: 'mt-4 px-3 text-gray-800',
  ...
  blueprint: {
    ...
    sectionContentStyle: 'mt-3 ml-2 text-gray-800 border-l-2 border-blue-200 pl-4',
  ...
  gradient: {
    ...
    sectionContentStyle: 'mt-3 bg-white/90 rounded-lg p-4 shadow-sm text-gray-800',
  ...
  retro: {
    ...
    sectionContentStyle: 'mt-3 border-2 border-amber-200 p-3 text-gray-800',
