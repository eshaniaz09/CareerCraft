...
export function DownloadOptions({ cvData }) {
  const [isGenerating, setIsGenerating] = useState(false);

  const generateHtmlContent = () => {
    const cvDocument = document.querySelector("#cv-preview").cloneNode(true);
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <Button
          variant="outline"
          className="flex items-center gap-2 justify-center transition-all hover:text-gray-600"
          onClick={exportHtml}
        ...
        {/* Uncomment if PDF export is needed */}
        {/* <Button
          variant="outline"
