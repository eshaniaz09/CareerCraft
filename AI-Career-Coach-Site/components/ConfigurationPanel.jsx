...
import { Settings, GripVertical, MoveUp, MoveDown, Trash2Icon } from 'lucide-react';
import { toast } from 'sonner';

export function ConfigurationPanel({ cvData, onChange }) {
  ...
  const handleTitleChange = (section, value) => {
    setSectionConfig(prev => ({
      ...prev,
      titles: {
        ...prev.titles,
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4">
              {sectionConfig.order.map((sectionKey, index) => (
                <div
                  key={sectionKey}
                  className="flex items-center gap-3 p-3 text-gray-800 bg-gray-50 rounded-md border"
                >
